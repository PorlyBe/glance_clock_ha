"""Color utility functions for Glance Clock integration."""
import logging
...
def parse_color_input(color_input, default_color: int) -> int:
    """Parse color input from service call, supporting hex strings, integers, and RGB arrays."""
...
def interpolate_color(value: float, min_val: float, max_val: float, 
                     min_color: int, max_color: int) -> int:
